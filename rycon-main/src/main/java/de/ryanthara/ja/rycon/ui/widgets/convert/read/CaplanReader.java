...
/**
 * Instances of this class are used for reading Caplan K files from the {@link ConverterWidget} of <tt>RyCON</tt>.
 *
 * @author sebastian
 * @version 2
 * @since 12
 */
public class CaplanReader implements Reader {

    private final static Logger logger = Logger.getLogger(CaplanReader.class.getName());
    ...
    /**
     * Reads the Caplan K file given as parameter and returns the reader file success.
     *
