...
public class FileUtils {
     ...
     */
    public static List<Path> listFiles(String directory, Filter<Path> filter) {
    ...
    private static class TreeCopier implements FileVisitor<Path> {
         ...
         *
         * @param file      a reference to the file
         * @param exception the I/O exception that prevented the file from being visited
         * @return the visit result
         */
        @Override
        public FileVisitResult visitFileFailed(Path file, IOException exception) {
            if (exception instanceof FileSystemLoopException) {
                logger.warn("Cycle detected '{}'.", file, exception.getCause());
            } else {
                logger.warn("Unable to copy '{}'.", file, exception.getCause());
            }
