...
public class CommandLineInterfaceException extends Exception {
     ...
     * message of {@code (cause==null ? null : cause.getName())} (which
     ...
     * @since 1.4
     */
    public CommandLineInterfaceException(Throwable cause) {
        super(cause);
    }
     ...
     * @since 1.7
     */
    protected CommandLineInterfaceException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
