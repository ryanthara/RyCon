...
/**
 * The <tt>GeneralPreferenceTab</tt> holds all the general preferences of <tt>RyCON</tt> in a composite.
 *
 * @author sebastian
 * @version 1
 * @since 25
 */
public class GeneralPreferenceTab extends PreferenceTab {

    /**
     * Constructor that matches the super() constructor.
     */
    GeneralPreferenceTab(Composite parent) {
    ...
    public String getText() {
        return ResourceBundleUtils.getLangString(PREFERENCES, Preferences.generalTabTitle);
    }
    ...
    public String getToolTipText() {
        return ResourceBundleUtils.getLangString(PREFERENCES, Preferences.generalTabToolTip);
    }
    ...
    public void createContent() {
        ...
        addCategory(GeneralPreferenceTab.class.getSimpleName());
        ...
        this.addPreference(new PreferenceBoolean("BooleanPreference", false) {
