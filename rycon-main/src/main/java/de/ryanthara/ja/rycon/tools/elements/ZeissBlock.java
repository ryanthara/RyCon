 ...
 *
 * This file is part of the package de.ryanthara.ja.rycon.tools.elements
 *
...
import de.ryanthara.ja.rycon.converter.zeiss.ZeissTypeIdentifier;

/**
 * This class defines an helper for operations on Zeiss measurement and coordinate files.
 *
 * @author sebastian
 * @version 1
 * @since 12
...
public class ZeissBlock {
    ...
    private ZeissTypeIdentifier typeIdentifier;

    /**
     * Defines the Zeiss block and it's attributes.
     *
