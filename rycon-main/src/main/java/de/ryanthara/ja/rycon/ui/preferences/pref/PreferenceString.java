...
/**
 * {@code PreferenceString} is for single line string values used in RyCON.
 * <p>
...
public abstract class PreferenceString extends Preference<String> {
     ...
     */
    protected PreferenceString(String label) {
        super(label);
    }
     ...
     */
    protected PreferenceString(String label, String defaultValue) {
