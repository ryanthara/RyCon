 ...
 */
package de.ryanthara.ja.rycon.gui.widgets.generate;

import de.ryanthara.ja.rycon.gui.widgets.GeneratorWidget;
 ...
 * @since 12
 */
public class AdminCopyWarnAndErrorMessage implements CopyWarnAndErrorMessage {
    ...
    public String getErrorMessage(String number) {
        return String.format(ResourceBundleUtils.getLangString(ERRORS, Errors.adminDirCopy), number);
    }
    ...
    public String getWarnMessage(String number) {
        return String.format(ResourceBundleUtils.getLangString(WARNINGS, Warnings.adminDirExists), number);
    }

} // end of AdminCopyWarnAndErrorMessage
