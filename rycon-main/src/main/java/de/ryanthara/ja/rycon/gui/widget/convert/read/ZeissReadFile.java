...
/**
 * Instances of this class are used for reading Zeiss REC files from the {@link ConverterWidget} of RyCON.
 *
 * @author sebastian
 * @version 2
 * @since 12
 */
public class ZeissReadFile implements ReadFile {
     ...
     */
    public ZeissReadFile(Shell innerShell) {
    ...
    public boolean readFile(Path file2Read) {
        ...
        if (lineReader.readFile()) {
            ...
            MessageBoxes.showMessageBox(innerShell, SWT.ICON_ERROR, Labels.getString("errorTextMsgBox"),
                    Errors.getString("zeissReadingFailed"));
