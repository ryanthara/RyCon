...
public class ReferenceLineStructure extends LeicaLogfileBaseStructure {
    ...
    /**
     * Analyze the REFERENCE LINE structure of the <tt>Leica Geosystems</tt> logfile.txt and
    ...
    public boolean analyze() {
        ...
        System.out.println("REFERENCE LINE structure");
