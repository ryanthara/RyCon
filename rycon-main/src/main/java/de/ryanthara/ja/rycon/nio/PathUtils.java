...
/**
 * General {@link java.nio.file.Path} manipulation utilities.
 * <p>
...
public class PathUtils {
     ...
     */
    static Path prepareOutputFileName(final Path path, final String editString, final String fileNameExtension) {
     ...
     */
    static Path removeExtension(Path filename) {
        if (filename == null) {
            return null;
        }
