...
import de.ryanthara.ja.rycon.ui.preferences.editor.EditorBoolean;
import de.ryanthara.ja.rycon.ui.preferences.validator.Validator;

/**
 * {@code PreferenceBoolean} is for boolean values used in RyCON.
 * <p>
...
public abstract class PreferenceBoolean extends Preference<Boolean> {
    ...
    /**
     * Constructs a new instance of {@code PreferenceBoolean} according to the parameters.
     *
     * @param label        text string of the preference
     * @param defaultValue default value for the preference
     */
    protected PreferenceBoolean(String label, Boolean defaultValue) {
     ...
     */
    @Override
    public Editor<Boolean> getEditor() {
