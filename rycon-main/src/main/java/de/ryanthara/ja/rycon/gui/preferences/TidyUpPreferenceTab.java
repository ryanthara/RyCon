...
/**
 * The <tt>TidyUpPreferenceTab</tt> holds all the preferences for the tidy up modul of <tt>RyCON</tt> in a composite.
 *
 * @author sebastian
 * @version 1
 * @since 25
 */
public class TidyUpPreferenceTab extends PreferenceTab {

    /**
     * Constructor that matches the super() constructor.
     */
    TidyUpPreferenceTab(Composite parent) {
    ...
    /* Throws an SWTException if the receiver can not be accessed by the caller. */
        ...
        addCategory(TidyUpPreferenceTab.class.getSimpleName());
    ...
    public String getText() {
        return ResourceBundleUtils.getLangString(PREFERENCES, Preferences.tidyUpTabTitle);
    }
    ...
    public String getToolTipText() {
        return ResourceBundleUtils.getLangString(PREFERENCES, Preferences.tidyUpTabToolText);
    }

} // end of TidyUpPreferenceTab
