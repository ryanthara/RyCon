...
public final class BigDataCopyWarnAndErrorMessage implements CopyWarnAndErrorMessage {
    ...
    public String getErrorMessage(String number) {
        return String.format(ResourceBundleUtils.getLangString(ERROR, Errors.bigDataDirCopy), number);
    }
    ...
    public String getWarnMessage(String number) {
        return String.format(ResourceBundleUtils.getLangString(WARNING, Warnings.bigDataDirExists), number);
    }
