...
/**
 * The {@code FileChoosers} enumeration holds all the texts for the file choosers of RyCON.
 * <p>
 ...
 * @since 2.0
 */
public enum FileChoosers implements ResourceKey {
    ...
    filterNameGsiLevel,
    filterNameK,
    filterNameLeicaObservations,
    filterNameLeicaProtocol,
    filterNameLogfileTxt,
    filterNameLtop,
    filterNameMep,
    filterNameNigraAltitudeRegisterAsc,
    filterNameNigraAltitudeRegisterHvz,
    filterNameNigraCalculations,
    filterNameNivNetOutput,
    filterNamePts,
    filterNameTxt,
    filterNameTxtCode,
    filterNameZeiss,
