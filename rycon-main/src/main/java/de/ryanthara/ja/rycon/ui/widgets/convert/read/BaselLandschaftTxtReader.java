 ...
 * Landschaft (Switzerland) in the {@link ConverterWidget} of RyCON.
 *
 * @author sebastian
 * @version 2
 * @since 12
 */
public class BaselLandschaftTxtReader extends Reader {
    ...
    public boolean readFile(Path file2Read) {
        ...
        if (lineReader.readFile(false)) {
            ...
            MessageBoxes.showMessageBox(innerShell, SWT.ICON_ERROR,
                    ...
                    ResourceBundleUtils.getLangString(ERROR, Errors.txtBLReadingFailed));
