...
/**
 * The {@code Buttons} enumeration holds all the texts for the buttons of RyCON.
 * <p>
 ...
 * @since 2.0
 */
public enum Buttons implements ResourceKey {
    ...
    radioBtnLevelGsi16,
    radioBtnLevelTxt,
    radioBtnComputeGpsref,
    radioBtnComputeReframe,
    settingsText,
    settingsToolTip,
    splitterText,
    splitterToolTip,
