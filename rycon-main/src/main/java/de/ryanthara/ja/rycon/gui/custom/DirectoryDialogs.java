...
public class DirectoryDialogs {
    ...
    /**
     * Shows a {@link DirectoryDialog} which is used in different widgets of RyCON's gui.
     * <p>
     * The filter path is checked against a stored value in the preferences file of RyCON.
     *
