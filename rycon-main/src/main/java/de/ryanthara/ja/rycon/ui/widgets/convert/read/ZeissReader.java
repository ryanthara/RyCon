...
/**
 * A reader for reading Zeiss REC files in the {@link ConverterWidget} of RyCON.
 *
 * @author sebastian
 * @version 2
 * @since 12
 */
public class ZeissReader extends Reader {

    private static final Logger logger = LoggerFactory.getLogger(ZeissReader.class.getName());
     ...
     */
    public ZeissReader(Shell innerShell) {
    ...
    /**
     * Reads the Zeiss REC file given as parameter and returns the read file success.
     *
    ...
    public boolean readFile(Path file2Read) {
        ...
        if (lineReader.readFile(false)) {
            ...
            MessageBoxes.showMessageBox(innerShell, SWT.ICON_ERROR,
                    ...
                    ResourceBundleUtils.getLangString(ERROR, Errors.zeissReadingFailed));
