...
public class BigDataCopyWarnAndErrorMessage implements CopyWarnAndErrorMessage {
    ...
    public String getErrorMessage(String number) {
        return String.format(ResourceBundleUtils.getLangString(ERRORS, Errors.bigDataDirCopy), number);
    }
    ...
    public String getWarnMessage(String number) {
        return String.format(ResourceBundleUtils.getLangString(WARNINGS, Warnings.bigDataDirExists), number);
    }
