...
/**
 * A ReferenceLineProcessor clears up a known Reference Line block from a Leica Geosystems logfile.txt file.
 *
 * @author sebastian
 * @version 1
 * @since 26
 */
public final class ReferenceLineProcessor implements Processor {

    /**
     * ReferenceLineProcessor is non-instantiable.
     */
    private ReferenceLineProcessor() {
        throw new AssertionError();
    }

    /**
     * Clears up the unnecessary lines from the logfile.txt file that was written
     * by the Reference Line program.
     *
     * @param block Reference Line logfile block
     * @return cleared up Reference Line block
     */
    public static List<String> run(List<String> block) {
        ...
        Objects.requireNonNull(result, "Reference Line logfile block is null!");
