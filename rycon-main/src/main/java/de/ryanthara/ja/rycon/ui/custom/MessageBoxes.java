...
/**
 * This class provides a simple {@code MessageBox} with static access for RyCON's ui elements.
 *
 * @author sebastian
 * @version 1
 * @since 12
...
public class MessageBoxes {
    ...
    /**
     * Shows a swt {@code MessageBox} and returns an integer value as indicator for being shown.
     *
