...
class ReferenceLineStructureTest {
    ...
    void getDesignLineOffsets() {
        ...
        assertTrue(referenceLineStructure.getDesignLineOffsets().equals(designLineOffsets));
    }
    ...
    void getDesignPoint() {
        ...
        assertTrue(referenceLineStructure.getDesignPoint().equals(designPoint));
    }
    ...
    void getEndPoint() {
        ...
        assertTrue(referenceLineStructure.getEndPoint().equals(endPoint));
    }
    ...
    void getMeasuredLineOffset() {
        ...
        assertFalse(referenceLineStructure.getMeasuredLineOffset().equals(lineOffset1));
        assertTrue(referenceLineStructure.getMeasuredLineOffset().equals(lineOffset2));
    }
    ...
    void getMeasuredPoint() {
        ...
        assertFalse(referenceLineStructure.getMeasuredPoint().equals(measuredPoint1));
        assertTrue(referenceLineStructure.getMeasuredPoint().equals(measuredPoint2));
    }
    ...
    void getStakedPoint() {
        ...
        assertTrue(referenceLineStructure.getStakedPoint().equals(stakedPoint));
    }
    ...
    void getStakeoutDifference() {
        ...
        assertTrue(referenceLineStructure.getStakeoutDifference().equals(stakeoutDifference));
    }
    ...
    void getStartPoint() {
        ...
        assertTrue(referenceLineStructure.getStartPoint().equals(startPoint));
    }
    ...
    void getTpsStation() {
        ...
        assertTrue(referenceLineStructure.getTpsStation().equals(tpsStation));
    }
...
} // end of ReferenceLineStructureTest