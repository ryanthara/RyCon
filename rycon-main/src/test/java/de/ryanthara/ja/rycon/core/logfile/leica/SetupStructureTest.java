...
class SetupStructureTest {
    ...
    void getStation() {
        ...
        assertTrue(setupStructureKnownAzimuth.getStation().equals(stationKnownAzimuth));
        assertTrue(setupStructureKnownBacksightPoint.getStation().equals(stationKnownBacksightPoint));
        assertTrue(setupStructureOrientationAndHeightTransfer.getStation().equals(stationOrientationAndHeightTransfer));
        assertTrue(setupStructureResection.getStation().equals(stationResection));
        assertTrue(setupStructureResectionHelmert.getStation().equals(stationResectionHelmert));
        assertTrue(setupStructureResectionLocal.getStation().equals(stationResectionLocal));
    }
